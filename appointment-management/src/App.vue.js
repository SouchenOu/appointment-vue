...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)({ ...{ class: ("text-4xl font-semibold text-center text-gray-800 bg-gradient-to-r from-blue-500 to-teal-500 text-transparent bg-clip-text p-6 shadow-lg rounded-lg") }, });
    ...
    __VLS_styleScopedClasses['to-teal-500'];
